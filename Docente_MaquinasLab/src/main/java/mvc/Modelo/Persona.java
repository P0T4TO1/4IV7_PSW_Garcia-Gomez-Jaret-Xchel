...
public class Persona {
    ...
    public void setPersona_password(String persona_pass) {
        this.persona_password = persona_pass;
    }
    ...
    public Persona verificarUsuario(String user, String pass) throws ClassNotFoundException{
        ...
        try{
            ...
            String q = "select * from persona "
                    ...
                    + "on (persona.privilegio_id = privilegio.privilegio_id) "
                    + "where persona_user = ? and persona_pass = ?";
