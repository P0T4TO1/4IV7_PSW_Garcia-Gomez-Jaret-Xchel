        ...
        <div class="container h-100">
            <div class="row h-100">
                <div class="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                    <div>
                        <p class="mb-4">Si usted necesita crear un reporte para un equipo de algún laboratorio de click en el botón de abajo</p><button class="btn btn-primary fs-5 me-2 py-2 px-4 btn-reportes" type="button" style="font-size: 16px !important;">Crear un reporte aqui!</button>
                    </div>
                </div>
            </div>
        </div>
