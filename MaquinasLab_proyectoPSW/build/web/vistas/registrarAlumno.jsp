                    ...
                    <form class="user" method="post" name="registro" action="../servletPersona?accion=registrarAlumno">
                        <div class="row mb-3">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input class="form-control form-control-user" type="text" placeholder="Boleta" required="" name="bol_alumno">
                            </div>
                            <div class="col-sm-6"><input class="form-control" type="date" name="fecha_nac"></div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input class="form-control form-control-user" type="text" placeholder="Nombre" required="" name="nombre">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input class="form-control form-control-user" type="text" placeholder="Apellido Paterno" required="" name="appat">
                            </div>
                            <div class="col-sm-6">
                                <input class="form-control form-control-user" type="text" placeholder="Apellido Materno" required="" name="apmat">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input class="form-control form-control-user" type="text" placeholder="Usuario" required="" name="usuario">
                            </div>
                            <div class="col-sm-6">
                                <input class="form-control form-control-user" type="password" placeholder="Contraseña" required="" name="password" id="inputPassword">
                        ...
                        <div class="mb-3">
                            <select class="form-select" name="grupo">
                                <optgroup label="Grupo">
                                    <option value="none" selected="">Grupo</option>
