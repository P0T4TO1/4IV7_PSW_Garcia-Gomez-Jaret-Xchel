    ...
    <nav id="navbar-main" class="navbar navbar-dark navbar-expand-md bg-dark py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="https://www.cecyt9.ipn.mx#" target="_blank">
            ...
            <div id="navcol-1" class="collapse navbar-collapse">
                ...
                </ul><a class="nav-link text-light" href="#">Iniciar Sesion</a>
                <div class="dropdown"><a class="dropdown-toggle text-light nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">Registrarse</a>
                    <div class="dropdown-menu"><a class="dropdown-item" href="#">Registrar Alumno</a><a class="dropdown-item" href="#">Registrar Empleado</a>
				</div>
                </div>
            </div>
        </div>
